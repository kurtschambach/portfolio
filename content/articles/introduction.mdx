...
The theme was inspired by [monkeytype](https://monkeytype.com/) (the superuser theme), 
...
As I've written in the README too, I am aware of the code not being the best, but I will refactor it in the near future (hopefully).
