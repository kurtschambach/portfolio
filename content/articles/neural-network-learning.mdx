...
While training the NN, it needs to somehow know which variables (i.e. thresholds, weigths, etc.) it has to improve, 
...
We want to find the minimal point of the whole errorfunction, i.e. the global minimum.
