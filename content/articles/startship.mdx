...
but also good to add some helpful information, for example the current branch, node or python version, and much more...

![](/blog-images/starship-shell.png)

## Installation

Starship is aviable for many OS:
...
Add these lines to your shells configuration file:
