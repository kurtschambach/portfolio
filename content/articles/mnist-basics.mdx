...
> "garbage in, garbage out" - ancient chinese proverb A note[^1]
...
Because of this we will need many data, and data for every possible situation, to represent the reality.
