...
> This would by the way be an extreme example for **overfitting**, i.e. the NN get's used to the data it is trained with, 
...
[^1]: I actually stole this idea from [mikhail berkovs](https://github.com/uhasker/) 
    book on [NextJS](https://uhasker.github.io/getting-things-done-in-next-js/). 
