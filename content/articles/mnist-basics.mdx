...
> (a program is quicker to write, not as complex as a NN, and you have no room for errors)

> This would by the way be an extreme example for **overfitting**, e.g. the NN get's used to the data it is trained with, 
> but it won't get better on unknown data. (That's also why you more training is not equal to better accuracy)
...
and can improve the Tresholds.


## Why is good Data so important?

> "garbage in, garbage out" - ancient chinese proverb [¹]
...
[¹] i actually stole this idea from [mikhail berkovs](https://github.com/uhasker/) [book on NextJS](https://uhasker.github.io/getting-things-done-in-next-js/).
Maybe try to read some of his articles, he has definitley more experience in writing them ;)