				...
				<button
					...
					className={`${
						alreadyVoted
							...
							: "h-fit"
					} origin-bottom bg-transparent border-2 border-primary/60 hover:border-primary dark:border-text dark:hover:border-dark-bg text-primary/60 hover:text-primary dark:text-text dark:hover:text-dark-bg font-bold p-2 rounded-lg duration-500`}
				>
					<ThumbsUp />
				</button>
				...
				<button
					...
					className={`${
						alreadyVoted
							...
							: "h-fit"
					} origin-bottom bg-transparent border-2 border-violet/60 hover:border-violet dark:border-text dark:hover:border-dark-bg text-violet/60 hover:text-violet dark:text-text dark:hover:text-dark-bg font-bold p-2 rounded-lg duration-500`}
				>
					<ThumbsDown />
				</button>
