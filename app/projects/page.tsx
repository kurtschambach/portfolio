              ...
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                {featured.appLogo ? (
                  <div className="flex flex-row items-center justify-between gap-0 mt-4">
                    ...
                    <div className="rounded-full h-fit w-fit ring-2 ring-mantle group-hover:ring-text shadow-md shadow-crust group-hover:shadow-text duration-150 delay-300 ring-offset-2 ring-offset-crust">
                      <Image
                        width={36}
                        height={36}
